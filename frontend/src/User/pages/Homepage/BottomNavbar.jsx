      ...
      >
        ...
        <Link>
          <Menu w="10px">
            <MenuButton
              ...
              py="1"
            >
              <span style={{ color: "white" }}>Fruits</span>
            </MenuButton>
          </Menu>
        </Link>
        ...
        <Link>
          <Menu w="10px">
            <MenuButton
              ...
              borderRadius={5}
            >
              <span style={{ color: "white" }}>Vegetables</span>
            </MenuButton>
        ...
        <Menu w="10px">
          <MenuButton
            ...
            borderRadius={5}
          >
            <span style={{ color: "white" }}>Meat and Seafood</span>
          </MenuButton>
          <MenuList zIndex={3} color="black">
            <HStack>
              <Grid>
        ...
        <Link>
          <Menu w="10px">
            <MenuButton
              ...
              borderRadius={5}
            >
              <span style={{ color: "white" }}>Dairy and Eggs</span>
            </MenuButton>
            <MenuList zIndex={3} color="black">
              <HStack>
                <Grid>
